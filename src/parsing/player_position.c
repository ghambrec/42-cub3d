...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/05 12:28:49 by ghambrec          #+#    #+#             */
/*   Updated: 2025/12/05 12:29:00 by ghambrec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_player_dir(t_game *game, char dir)
{
	...
	game->player.plane.x = -game->player.dir.y * GAME_FOV / 100;
	game->player.plane.y = game->player.dir.x * GAME_FOV / 100;
}
